...
class MovementServiceTest {
    ...
    void fixedRateWithIncompleteInputsFallsBackToSnapshots() {
        HoldingResponse holding = new HoldingResponse(
                ...
                null, "Bank", "INR", new BigDecimal("1000"), new BigDecimal("1000"), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO,
    ...
    private HoldingResponse manualHolding(String currentValue) {
        return new HoldingResponse(
                ...
                null, "Kite", "INR", new BigDecimal("100"), new BigDecimal(currentValue), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO,
                null, null, null, null, null, null, null, null, null, null, false, false, null, null, Set.of(), Instant.now(), Instant.now(), null, false, null);
    }
    ...
    private HoldingResponse fixedRateHolding(String principal, String rate, CompoundingFrequency frequency, LocalDate start) {
        ...
        return new HoldingResponse(
                ...
                null, "HDFC", "INR", principalValue, currentValue, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO,
